...
# Spec: 首サーボ適合 / XIAO・スピーカー配線スペース / 背面スイッチ穴
# =========================================================
...
# 002_Neck_Joint_Mount から繋がるSG90サーボの耳ピッチ
servo_pitch  = 27.5

# 土台（ボディ）の全体サイズ
body_r       = 35.0    # 土台の半径（直径70mmの安定感ある卓上サイズ）
...
print("003_Body_Base_Case.py: 電子部品スペースと背面スイッチ・ヒューズ穴を備えた土台が生成されました！")
